...
export async function forecast(l:Location,pastDays:number,signal?:AbortSignal){return get<WeatherResponse>(`${F}?${q({latitude:l.latitude,longitude:l.longitude,timezone:l.timezone,forecast_days:16,past_days:pastDays,daily,hourly})}`,signal)}
